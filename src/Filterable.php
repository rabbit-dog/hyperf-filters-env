...
trait Filterable
{
     ...
     * @return \Hyperf\Database\Model\Builder | mixed
     */
     ...
     * @param int|null $page
     * @return \Hyperf\Paginator\LengthAwarePaginator | mixed
     *
     * @throws \InvalidArgumentException
     */
    public function scopePaginateFilter($query, $perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
    {
        $perPage   = $perPage ?: config('eloquent_filter.paginate_limit');
    ...
    {
        if ($filter === null) {
            $filter = config('eloquent_filter.namespace', 'App\\ModelFilters\\') . class_basename($this) . 'Filter';
        }
